...
- **prod carries the 2026-09-10/11 run** — accounts, rolling sessions, the `iiii` room and its tools, private p2p. Promoted on the owner's word, 2026-09-11. aylmo runs `0.4.15-place.1` (packed 2026-09-22 from #534, the place-and-lights landing) at https://local.thedi.studio; port 443 comes from setcap on the node binary, which a Node upgrade wipes.
