...
This document is the permanent record of what di.iiii is, what it is becoming, and what cannot be traded away. Read it before making product or architecture decisions. Update it when a fundamental truth changes — not when a task changes.
