...
/* ---------- index ---------- */
.indexPane{max-width:var(--col);padding:44px var(--pad) 26px var(--pad);}
...
/* ---------- room ---------- */
.room-header{padding:26px var(--pad) 0 var(--pad);max-width:var(--col);
...
.room-stage{max-width:var(--col);padding:56px var(--pad) 0 var(--pad);}
