...
description: 'Route feature work across Studio, Raw, src/project, src/shared, serverXR, scripts, and deploy. Use when deciding where code belongs, whether a change is shared or lane-specific, and what adjacent files and validations to check.'
...
4. If the answer is no, decide whether the behavior is shipped Studio work or experimental Raw work.
...
- If Studio and Raw should both benefit, prefer src/project.
...
- If the change is intentionally experimental or node-first, prefer src/raw. (Beta was retired 2026-08-06 and absorbed into Raw; src/beta no longer exists.)
