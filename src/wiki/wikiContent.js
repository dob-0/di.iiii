    ...
    },
    {
        ...
        body: [
            ...
            { list: [
                ...
                'The front door is a poster, not a cutting room. It shows the piece moving as a 2D canvas sketch, carries the artist’s statement verbatim, and names the seven movements in order — and nothing on it measures the work: no clock, no timecodes, no edit timeline. The draggable timeline of clip windows and their overlaps was removed on 2026-08-04, because a scrubber over the composition contradicts a piece whose subject is a system that composes without being seen, and contradicted the page’s own lede (“there is nothing to operate”) sitting directly above it; the windows still live in sequences/index.js and the director panel. The page exists because entering costs a 1.6 MB renderer and a strobing piece that carries a photosensitivity warning, and neither should be spent on somebody who has only followed a link. It loads no three.js at all, opens on a held frame when the visitor’s system asks for reduced motion, and keeps one control — pause/play the preview — because motion that starts by itself has to be stoppable.',
