...
export const WIKI_ARTICLES = [
    ...
    },
    {
        ...
        body: [
            ...
            { list: [
                'Endpoint — a chat URL. The address a local server prints on startup is enough: a bare host such as http://localhost:11434, or an OpenAI base URL such as http://127.0.0.1:8090/v1, is completed to its chat route for you. Anything already pointing at a full path is used as given.',
                'Model — the model name that server knows, for example qwen3-4b.',
                'System — an optional instruction that shapes every answer.'
            ] },
            'It speaks to Ollama and to any OpenAI-compatible server — llama.cpp, vLLM, LM Studio — because they all accept the same request. If a reasoning model wraps its working in <think> tags, that part is dropped and only the answer is shown. If the reply was cut off mid-sentence the panel says so rather than presenting a fragment as complete.',
        ...
        tags: ['raw', 'nodes', 'keeper', 'agent', 'llm', 'local', 'offline', 'ollama', 'llama.cpp', 'openai'],
        updated: '2026-08-11'
    },
    {
        id: 'midi-in-node',
