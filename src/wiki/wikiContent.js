    ...
    },
    {
        ...
        body: [
            ...
            { list: [
                ...
                'A Director node (view.director) is the algovrithm editor, moved out of the piece into Raw on 2026-08-05: retime and reorder its beats, edit each room’s colour, fog and lights, and drop assets onto the timeline. “Save to source” writes src/algoVrithm/sequences/index.js in place with its comments intact. The piece itself (/algovrithm/scene) now carries no editor at all — it plays itself, full screen, and in VR or AR.'
            ] }
        ],
