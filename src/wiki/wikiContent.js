    ...
    },
    {
        ...
        body: [
            ...
            { list: [
                ...
                'Starting from nothing: a blank Raw workspace shows a “Make me a scene” button in the canvas’s lower band (out of the double-click zone). It builds a room with a light, a cube, a colour wired into that cube, and an empty Model node waiting for your own file — plus a note giving the moves in plain words. It is there because a blank workspace opens with no toolbar at all, so the ⋯ menu (which also offers it) does not exist for the person most likely to want it.',
                'The Geo is the plain container — TouchDesigner’s Geometry COMP, by name. It arrives empty but is visibly a place (a faint floor tile marks its footprint), you enter it and collect what you need — objects, models, Lights — and everything renders inside it and travels with it. It adds nothing of its own: no shell, no wiring, no rules. When in doubt, build in a Geo.',
