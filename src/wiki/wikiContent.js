    ...
    },
    {
        ...
        body: [
            ...
            { list: [
                ...
                'A Light can stand somewhere now: placed inside any container it is a real point light with a small glowing marker — colour, intensity and position of its own. At the top level it keeps its old job untouched: the scene’s ambient and directional settings.',
                ...
                'The Monitor is the canvas\'s viewer window: wire any texture into its Source — a Webcam\'s Frame — and watch it live while you keep wiring, TouchDesigner\'s operator viewer as a window. It only watches; rooms have the World window, the Room button and /out.',
