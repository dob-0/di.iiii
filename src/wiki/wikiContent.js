...
export const WIKI_ARTICLES = [
    ...
    },
    {
        ...
        body: [
            ...
            'The front door IS the room. Opening di-studio.xyz no longer shows a page about the space with the space drawn behind it — it opens the space: the name and the one line stand inside it as things you can walk past, and the doors to the works are the real links. /main still opens the same room, because an address in circulation is never withdrawn, and the old landing page is moved rather than deleted — it is at /?tour=1.',
