    ...
    },
    {
        ...
        body: [
            ...
            { list: [
                ...
                'The room lives behind the graph — the moment something stands in it. A clear desk is flat paper with its own grid; place the first thing at this level (a Geo, a cube) and the room appears behind your cards, whatever node you are standing in. The Room button (or ⤢) takes it fullscreen for arranging, and fullscreen survives walking through doors: each door swaps which room fills the screen.',
