...
export const WIKI_ARTICLES = [
    ...
    },
    {
        ...
        body: [
            ...
            { list: [
                ...
                'The room is behind the graph now, everywhere: whatever node you are standing in, its room renders as the canvas itself, cards floating on top — place something and it appears behind your cards as you work. The Room button (or ⤢) takes it fullscreen for arranging, and fullscreen now survives walking through doors: each door swaps which room fills the screen.',
    ...
    },
    {
        ...
        summary: 'Raw has performable Fader / XY Pad / Button nodes — wire them into OSC Out or MIDI Out to control external software like TouchDesigner (OSC) and Ableton Live (MIDI), TouchOSC-style.',
        body: [
            'The Raw editor’s node palette has performable control nodes: Fader, XY Pad, and Button. Each card carries a playable widget right on the node — drag the fader, sweep the pad, hit the button — and outputs live values into the graph.',
        ...
        tags: ['raw', 'nodes', 'osc', 'midi', 'touchdesigner', 'ableton', 'control'],
        updated: '2026-08-19'
    },
    {
        id: 'wcc-exhibition',
