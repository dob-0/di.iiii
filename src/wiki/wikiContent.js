...
export const WIKI_ARTICLES = [
    ...
    },
    {
        ...
        body: [
            ...
            'Every public space carries a small “Made with di.iiii” mark in the bottom-left corner, so visitors who like what they see have a way in. At rest it is just the ◈ — the page is yours, and platform chrome should not sit on your work; point at it (or reach it with the keyboard) and it opens into the full “Made with di.iiii — build yours” link. It never appears on hub-card preview thumbnails.',
