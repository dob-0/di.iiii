...
describe('SeedHelpDialog', () => {
    it('opens on the current surface guide by default', () => {
        render(<SeedHelpDialog open surface="view" onClose={() => {}} />)
    ...
    it('switches sections from the help tabs', () => {
        render(<SeedHelpDialog open surface="world" onClose={() => {}} />)
    ...
    it('closes when escape is pressed', () => {
        const onClose = vi.fn()
        render(<SeedHelpDialog open surface="graph" onClose={onClose} />)
