export const SEED_WINDOW_PADDING = 12
export const DEFAULT_SEED_WORKSPACE_TOP = 64
...
export function clampWindowFrame(frame = {}, bounds = {}) {
    ...
    const minLeft = allowOverflowLeft
        ? null
        : (Number.isFinite(bounds.minLeft) ? bounds.minLeft : SEED_WINDOW_PADDING)
    ...
    const viewportPadding = Number.isFinite(bounds.viewportPadding) ? bounds.viewportPadding : SEED_WINDOW_PADDING
