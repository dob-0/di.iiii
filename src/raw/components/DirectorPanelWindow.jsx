...
import { PIECE_IDS, getPiece } from '../director/pieces.js'
...
// handed to the panel. The panel imports no piece of its own — adding a second
// one is a descriptor plus its modules, and nothing here changes.
//
...
// allow-list rather than trusting a path from here. That file stays the source
// of truth.
//
...
export default function DirectorPanelWindow({ node }) {
    ...
    // Keyed on the piece so switching to another one starts a fresh undo stack
    // rather than offering to undo one piece's edit into another's draft.
    const history = useEditHistory(piece.baseline, { enabled: true })
