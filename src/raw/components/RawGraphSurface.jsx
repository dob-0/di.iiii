...
// the card is the instrument, not just a wiring box. The widget's height
// is part of cardHeight at EVERY tier (the wires are drawn from it); only
// whether the widget is interactable changes with the LOD tier.
...
export default function RawGraphSurface({
    ...
    onDeleteNode,
    onMoveNode,
    // Optional, like every other mutation handler here: Studio wraps this
    // read-only and passes none, so control widgets render inert there.
    onChangeNodeValues,
    onDoubleClick,
                        ...
                        return (
                            ...
                            >
                                ...
                                <div style={{ position: 'relative', height: h - HEADER_HEIGHT }}>
                                    ...
                                    {showPorts && CONTROL_WIDGETS[node.typeId] ? (() => {
