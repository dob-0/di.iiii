...
import { assetFetchCacheMode } from '../utils/contentAddressedAsset.js'
...
export default function ModelObject({
    ...
    useEffect(() => {
        ...
        const readArrayBuffer = async (source) => {
            ...
            if (source.url) {
                // Models are often the largest asset in a scene, and this
                // load runs again on every remount: see assetFetchCacheMode
                // for why a legacy id revalidates rather than re-downloads.
                const cache = assetFetchCacheMode(source.url)
