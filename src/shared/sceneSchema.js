...
export const normalizeFixedCamera = (fixedCamera = {}) => {
    ...
    ops.forEach((op) => {
        ...
        switch (op?.type) {
            ...
            case 'updateObject': {
                ...
                // Pin the id — a patch carrying `id` would desync map key and
                // object id (duplicate ids, silent object loss on next apply).
