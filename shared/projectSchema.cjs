...
const PERFORM_PRESET_LIMIT = 24
const PERFORM_PRESET_WINDOW_LIMIT = 16
const defaultPerformState = {
  presets: []
}
...
const normalizePerformRect = (rect) => {
...
const normalizePerformPreset = (preset) => {
...
const normalizePerformState = (perform = {}) => {
...
const normalizeMappingEffect = (effect = {}) => {
...
module.exports = {
  ...
  defaultMappingState,
  defaultPerformState,
  PERFORM_PRESET_LIMIT,
  PERFORM_PRESET_WINDOW_LIMIT,
  ...
  normalizePerformState,
  normalizePerformPreset,
  normalizePerformRect,
