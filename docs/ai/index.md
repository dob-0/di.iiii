...
- [verification-charter.md](verification-charter.md) — what "done" means: verify as a human, desktop AND phone, before calling anything finished (evidence: 43/134 known defects are silent, 29 are mobile-only)
