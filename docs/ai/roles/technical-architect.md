...
| 6 | Studio is the main lane | Experimental node-lane behavior is not shipped as default UX |
...
- The task ships experimental node-lane behavior as the Studio default
